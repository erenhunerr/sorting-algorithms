...
class SortVisualiser:
    ...
    def config_root(self):
        ...
        self.root.set_theme('equilux')  # set window style theme
    ...
    def config_menu(self):
        ...
        tk.Button(self.menu_frame, text='Başlat', command=self.validate_setup, background="white", activebackground="green")
        tk.Button(self.menu_frame, text='Oluştur', command=self.clean_canvas, background="white", activebackground="green")
        ...
        #speed deneme
        dynamic_label = ttk.Label(self.menu_frame, text=f'Animation Speed: {self.anim_speed}', anchor='e')
        callback2 = self.menu_frame.register(self.change_anim_speed)
        ttk.Scale(self.menu_frame, command=(callback2))
    ...
    def change_anim_speed(self, value):
        ...
        self.anim_speed = (1-(float(value)))/25
